...
export default function PrivacyPolicy() {
  return (
    <div className='privacypolicy'>
      <h1>Privacy Policy of Corbii</h1>

      <p>Corbii operates the https://corbii-web.web.app/ website, which provides the SERVICE.</p>

      <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the Corbii-Web website.</p>
      ...
      <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at cogneurogo [AT] gmail [DOT] com.</p>
    </div>
  );
}